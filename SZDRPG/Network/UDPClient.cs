            ...
            if (lines.Length > 0)
            {
                ...
                for (int i = 0; i < int.Parse(lines[maplines]); i++)
                {
                    if (lines[entityLineNums + maplines + 1].Equals("NetworkPCharacter"))
                    {
                        ...
                        game.Characters[0].Display.State.facing = int.Parse(lines[entityLineNums + maplines + 6]);
                    ...
                    else if (lines[entityLineNums + maplines + 1].Equals("PCharacter"))
                    {
                        ...
                        character.Display.State.facing = int.Parse(lines[entityLineNums + maplines + 6]);
                    ...
                    else if (lines[entityLineNums + maplines + 1].Equals("PProjectile"))
                    {
                        ...
                        projectile.Display.State.facing = int.Parse(lines[entityLineNums + maplines + 6]);
